...
let languages = {
    ...
    en: {
      ...
      targetAudience:"An engineer working/living in urban area.",
      ...
      task1:"I interviewed people in their 20s and 30s about their movie reservation habits.",
      task2:"Make and iterate prototypes",
      task3:"Usability study 4 males, 1 female(Japan, China, Dutch, USA)",
      ...
      issue4:"Interviewees:",
      explain4:"9 males, 3 female(Japan, China, Dutch, USA)",

      persona_explain:"Persona:",
      persona:"I constructed Ryu who is from China and works as an engineer in Tokyo who wants to go see movies with his friends.",
      ...
      character_mockup1:"1.Home screen that shows available movies and theaters",
      character_mockup2:"2.Screen with details of the movie",
      ...
      conculusion_details:"After 5 user trials, seat reservation and now be done fast. It takes about a minute in my usability study.",
      learn_movie:"Learn:",
      learn_details:"A diverse group of user's opinions (Japanese, Dutch, American, Chinese, Taiwanese) made me realize my biases in my design work."
    }
